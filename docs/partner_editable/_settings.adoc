...
:partner-contributors: Anubhav Swami, Ray Gordon & David Sounthiraraj, {partner-company-name}
//:other-contributors: Akua Mansa, Trek10
//:aws-contributors: Anubhav Swami & David Sounthiraraj, Cisco Systems Inc.
:quickstart-contributors: Muffadal Quettawala & Shivansh Singh, AWS
...
// :no_parameters:
:git_repo_url: https://github.com/aws-quickstart/quickstart-cisco-secure-firewall-cloud-native/tree/main
