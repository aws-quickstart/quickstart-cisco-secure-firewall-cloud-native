...
:aws-contributors: Muffadal Quettawala
:quickstart-contributors: Shivansh Singh, Ray Gordon {partner-company-name}
...
// :no_parameters:
:git_repo_url: https://github.com/aws-quickstart/quickstart-cisco-secure-firewall-cloud-native
