...
** *Step 4 - Create Cisco Secure Firewall Cluster Stack*; refer to <<_deployment_options>> for a desciption of the options available and <<_launch_the_quick_start>> for deployment steps.
