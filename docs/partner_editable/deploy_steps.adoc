...
|https://github.com/aws-quickstart/quickstart-cisco-secure-firewall-cloud-native/blob/develop/templates/entrypoint-new-vpc.template.yaml[View template^]


|http://qs_launch_permalink[Deploy {partner-product-short-name} into an existing VPC on AWS^]
|https://github.com/aws-quickstart/quickstart-cisco-secure-firewall-cloud-native/blob/develop/templates/entrypoint-existing-vpc.template.yaml[View template^]


|http://qs_launch_permalink[Deploy a new tenant into an existing {partner-product-short-name} cluster on AWS^]
|https://github.com/aws-quickstart/quickstart-cisco-secure-firewall-cloud-native/blob/develop/templates/entrypoint-tenant-existing-cluster.template.yaml[View template^]
|===
...
==== Explore Use Case Examples and Scenarios
...
==== Explore the Secure Firewall Cloud Native GitHub
