...
* *Deploy a {partner-product-short-name} tenant into an existing VPC*. This option provisions a {partner-product-short-name} tenant in your existing AWS infrastructure.
